...
public class FlyCamera : MonoBehaviour
{
    ...
    */
    ...
    public float shiftAdd = 0.1f;   // Amount to accelerate when shift is pressed
    public float maxShift = 1.0f;  // Maximum speed when holding shift
    public float camSens = 0.1f;   // Mouse sensitivity
